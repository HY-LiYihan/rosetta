...
from app.workflows.corpus import prepare
...
def main() -> int:
    ...
    warnings.warn(
        "scripts/corpusgen/prepare_seeds.py is a legacy entrypoint; use "
        "scripts/tool/rosetta_tool.py corpus-prepare instead.",
        DeprecationWarning,
        stacklevel=2,
    )
    result = prepare(
