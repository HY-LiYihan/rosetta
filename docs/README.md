...
文档站顶部提供 `中文 / English` 语言切换入口。中文文档仍是完整主文档；English 入口提供概览、快速使用和 prompt 构成，避免把两种语言混在同一个介绍页里。
...
1. v4.5.22 已在文档站顶部新增 `中文 / English` 语言切换入口，并补充 English 概览、快速使用和 prompt 构成页面。
